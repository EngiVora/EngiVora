...
import { Search, X, Menu, LogOut, UserCircle } from "lucide-react";
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              {!isLoggedIn ? (
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Avatar name={user?.name} src={user?.profilePicture || user?.imageUrl} size="sm" className="border-2 border-slate-600 hover:border-sky-400 transition-colors" />
                    <span className="hidden lg:inline text-sm font-semibold text-slate-300 hover:text-sky-400 transition-colors">
                      {user?.name || "Profile"}
                    </span>
                  </Link>
                  <button
              ...
              <div className="flex flex-col gap-2">
                {!isLoggedIn ? (
                  ...
                  <div className="flex flex-col gap-2">
                    <Link
                      href="/profile"
                      className="flex items-center gap-2 text-sm font-medium text-slate-300 hover:text-sky-400 transition-colors py-2"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      <Avatar name={user?.name} src={user?.profilePicture || user?.imageUrl} size="sm" className="border-2 border-slate-600" />
