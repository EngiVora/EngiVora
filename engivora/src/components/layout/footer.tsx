    ...
    <footer className="border-t border-slate-800 bg-gradient-to-b from-slate-900 to-slate-950 glass-panel accent-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Services */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-slate-200">Services</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/exams"
          ...
          {/* Newsletter Signup */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-slate-200">Stay Updated</h3>
            <p className="text-slate-400 text-sm mb-4">
            ...
            <form onSubmit={handleNewsletterSignup} className="space-y-2">
              ...
              <Button type="submit" className="w-full bg-sky-600 hover:bg-sky-500 neon-ring" size="sm">
                Subscribe
