...
export function UserImportModal({ 
  ...
  const handleFile = (file: File) => {
    if (file.type !== "text/csv" && !file.name.endsWith('.csv')) {
      setValidation({ isValid: false, errors: ['Please select a valid CSV file'] })
      return
    }
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className={`text-sm font-medium ${
                    ...
                    {validation.isValid ? 'File is valid' : 'File validation failed'}
                  </h3>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {previewUsers.slice(0, 5).map((user, index) => (
                        <tr key={index}>
                          ...
                          <td className="px-3 py-2 text-sm text-gray-900">{user.status}</td>
                        </tr>
                      ))}
        ...
        <div className="flex items-center justify-between p-6 border-t border-gray-200 bg-gray-50">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              disabled={!validation?.isValid || previewUsers.length === 0 || isImporting}
