  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Documentation for the admin portal authentication</p>
      </div>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-sm">
                ...
                <li>Hardcoded demo credentials for testing</li>
              </ul>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">BCrypt for secure password storage</p>
                </div>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Only admin users can access admin routes</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Not suitable for production use</p>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border rounded-lg">
              ...
              <div className="space-y-1 text-sm">
                <p><strong>Email:</strong> admin@engivora.com</p>
            ...
            <div className="p-4 border rounded-lg bg-yellow-50">
              ...
              <p className="text-sm text-yellow-700">
                These credentials are hardcoded for development/testing purposes only. 
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground mt-1">Authenticate admin user</p>
              <div className="mt-2">
...
{`{
  ...
  "password": "string"
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground mt-1">Logout admin user</p>
            </div>

            <div className="p-4 border rounded-lg">
              <h3 className="font-medium">POST /api/auth/verify-token</h3>
              <p className="text-sm text-muted-foreground mt-1">Verify admin token</p>
              <div className="mt-2">
        ...
        <CardContent>
          <div className="space-y-4">
            <p className="text-yellow-700">
              <strong>Warning:</strong> This authentication system is intended for development and 
              testing purposes only. For production use, you should:
            </p>
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>Replace hardcoded credentials with a proper user management system</li>
