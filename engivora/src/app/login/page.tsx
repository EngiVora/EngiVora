        ...
        <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl border border-slate-800 overflow-hidden shadow-xl">
          <div className="px-6 py-8">
            ...
            <div className="mt-6 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
              <h3 className="text-sm font-medium text-slate-100 mb-2">Demo Credentials:</h3>
              <div className="text-sm text-slate-400 space-y-1">
                <p><strong className="text-slate-300">Email:</strong> student@example.com</p>
                <p><strong className="text-slate-300">Password:</strong> password123</p>
              </div>
            </div>
